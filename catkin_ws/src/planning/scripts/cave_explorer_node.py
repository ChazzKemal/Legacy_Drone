...
class CaveExplorerNode:
    def __init__(self):
        ...
        # Load parameters from the planner config
        self.max_radius = rospy.get_param("/cave_explorer/max_radius", 20.0)
        self.min_radius = rospy.get_param("/cave_explorer/min_radius", 3.0)
        self.sampling_angle_deg = rospy.get_param("/cave_explorer/sampling_angle_deg", 10)
        self.max_sampling_angle_deg = rospy.get_param("/cave_explorer/max_sampling_angle_deg", 50)
        self.max_planning_distance = rospy.get_param("/cave_explorer/max_planning_distance", 55.0)
