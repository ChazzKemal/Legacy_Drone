...
class ExplorationManager:
    def __init__(self):
        ...
        self.min_distance = rospy.get_param("/exploration_manager/min_distance", 30)
        self.min_distance_visited = rospy.get_param("/exploration_manager/min_distance_visited", 10.0)
        self.skip_for_loop_detection = rospy.get_param("/exploration_manager/skip_for_loop_detection", 10)
